...
CREATE TABLE IF NOT EXISTS PERSONA_STATS (
    ...
    TOTAL_SHOTS numeric NOT NULL DEFAULT 0,
    TOTAL_MISSED_SHOTS numeric NOT NULL DEFAULT 0,
    TIME_AS_ALLIED numeric NOT NULL DEFAULT 0,
    TIME_AS_AXIS numeric NOT NULL DEFAULT 0,
    TIME_IN_PORT numeric NOT NULL DEFAULT 0,
    TIME_IN_CITY numeric NOT NULL DEFAULT 0,
    TIME_IN_SEWERS numeric NOT NULL DEFAULT 0,
    TIME_IN_VILLAGE numeric NOT NULL DEFAULT 0,
    TIME_IN_MONASTERY numeric NOT NULL DEFAULT 0,
    TIME_IN_BASE numeric NOT NULL DEFAULT 0,
    TIME_IN_DM numeric NOT NULL DEFAULT 0,
    TIME_IN_TDM numeric NOT NULL DEFAULT 0,
    TIME_IN_INF numeric NOT NULL DEFAULT 0,
    ...
    COLT_SHOTS numeric NOT NULL DEFAULT 0,
    COLT_MISSED_SHOTS numeric NOT NULL DEFAULT 0,
    THOMPSON_KILLS numeric NOT NULL DEFAULT 0,
    THOMPSON_SHOTS numeric NOT NULL DEFAULT 0,
    THOMPSON_MISSED_SHOTS numeric NOT NULL DEFAULT 0,
    BAR_KILLS numeric NOT NULL DEFAULT 0,
    BAR_SHOTS numeric NOT NULL DEFAULT 0,
    BAR_MISSED_SHOTS numeric NOT NULL DEFAULT 0,
    GARAND_KILLS numeric NOT NULL DEFAULT 0,
    GARAND_SHOTS numeric NOT NULL DEFAULT 0,
    GARAND_MISSED_SHOTS numeric NOT NULL DEFAULT 0,
    SPRINGFIELD_KILLS numeric NOT NULL DEFAULT 0,
    SPRINGFIELD_SHOTS numeric NOT NULL DEFAULT 0,
    SPRINGFIELD_MISSED_SHOTS numeric NOT NULL DEFAULT 0,
    SHOTGUN_KILLS numeric NOT NULL DEFAULT 0,
    SHOTGUN_SHOTS numeric NOT NULL DEFAULT 0,
    SHOTGUN_MISSED_SHOTS numeric NOT NULL DEFAULT 0,
    BAZOOKA_KILLS numeric NOT NULL DEFAULT 0,
    BAZOOKA_SHOTS numeric NOT NULL DEFAULT 0,
    BAZOOKA_MISSED_SHOTS numeric NOT NULL DEFAULT 0,
    LUGER_KILLS numeric NOT NULL DEFAULT 0,
    LUGER_SHOTS numeric NOT NULL DEFAULT 0,
    LUGER_MISSED_SHOTS numeric NOT NULL DEFAULT 0,
    MP_KILLS numeric NOT NULL DEFAULT 0,
    MP_SHOTS numeric NOT NULL DEFAULT 0,
    MP_MISSED_SHOTS numeric NOT NULL DEFAULT 0,
    STG_KILLS numeric NOT NULL DEFAULT 0,
    STG_SHOTS numeric NOT NULL DEFAULT 0,
    STG_MISSED_SHOTS numeric NOT NULL DEFAULT 0,
    KARABINER_KILLS numeric NOT NULL DEFAULT 0,
    KARABINER_SHOTS numeric NOT NULL DEFAULT 0,
    KARABINER_MISSED_SHOTS numeric NOT NULL DEFAULT 0,
    GEWEHR_KILLS numeric NOT NULL DEFAULT 0,
    GEWEHR_SHOTS numeric NOT NULL DEFAULT 0,
    GEWEHR_MISSED_SHOTS numeric NOT NULL DEFAULT 0,
